...
-   **Privacy Focused**: No visitor analytics, tracking cookies, or server-side search history.
...
SendWindow does not collect visitor analytics, store search history, or set tracking cookies. Location and filter preferences are stored locally in the user's browser.
