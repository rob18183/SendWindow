    ...
    return (
        <div className="container" style={{ padding: '0 16px 40px 16px', maxWidth: 600, margin: "0 auto" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
                ...
                <section id="privacy">
                    <h2 style={{ fontSize: 18, marginBottom: 8 }}>Privacy</h2>
                    <p style={{ lineHeight: 1.6, color: "var(--color-text-dim)" }}>
                        SendWindow does not collect visitor analytics, store search history, or use tracking cookies.
                        Your saved location and preferences stay in your browser.
                    </p>
                </section>
